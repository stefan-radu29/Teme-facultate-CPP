...
Organic_fragment::Organic_fragment(const std::string& identifier, const std::string& size, const double level_of_infection, int quantity_of_micro_fragments, const std::string& photograph)
{
...
int Organic_fragment::get_quantity_of_micro_fragments() const
{
